...
const variants = {
  OutlineBluegray200:
    "bg-gray_50 border-bluegray_200 border-bw073 border-solid",
};
const shapes = { RoundedBorder5: "rounded-radius584" };
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#3b71fe",
              "&:hover": { backgroundColor: "#3b71fe", color: "#3b71fe" },
            }),
